...
class LetterZhPage extends StatefulWidget {
  const LetterZhPage({Key? key}) : super(key: key);

  @override
  State<LetterZhPage> createState() => _LetterZhPageState();
}

class _LetterZhPageState extends State<LetterZhPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ژ"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "ژاله", "en": "zhale", "desc": "شبنم، قطره‌های آب که صبحگاه بر گیاهان می‌نشیند"},
    {"fa": "ژست", "en": "zhest", "desc": "حالت و وضعیت بدن، به ویژه در عکاسی و تئاتر"},
    {"fa": "ژرف", "en": "zharf", "desc": "عمیق، پر محتوا و عمیق"},
    {"fa": "ژوپین", "en": "zhopin", "desc": "دامن زنانه کوتاه و چین‌دار"},
    {"fa": "ژولیده", "en": "zhoolide", "desc": "پریشان و آشفته (موی ژولیده)"},
    {"fa": "ژن", "en": "zhen", "desc": "واحد وراثتی در علم زیست‌شناسی"},
    {"fa": "ژنتیک", "en": "zhenetik", "desc": "علم مطالعه وراثت و تفاوت‌های فردی"},
  ];
}
...
class LetterZPage extends StatefulWidget {
  const LetterZPage({Key? key}) : super(key: key);

  @override
  State<LetterZPage> createState() => _LetterZPageState();
}

class _LetterZPageState extends State<LetterZPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ذ"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "ذات", "en": "zat", "desc": "سرشت، طبیعت درونی"},
    {"fa": "ذخیره", "en": "zakhire", "desc": "آنچه برای آینده نگهداری می‌شود"},
    {"fa": "ذره", "en": "zarre", "desc": "بخش بسیار کوچک از چیزی، اتم"},
    {"fa": "ذغال", "en": "zoghal", "desc": "سوخت سیاه و جامد حاصل از سوختن چوب"},
    {"fa": "ذکر", "en": "zekr", "desc": "یاد خدا کردن، نام خدا را بر زبان آوردن"},
    {"fa": "ذلیل", "en": "zalil", "desc": "خوار و حقیر، بی‌عزت"},
    {"fa": "ذوق", "en": "zoghh", "desc": "لذت، شادی و هیجان"},
    {"fa": "ذیذ", "en": "ziz", "desc": "نوعی حشره (پشه)"},
    {"fa": "ذائقه", "en": "zaege", "desc": "حس چشایی، توانایی تشخیص طعم"},
  ];
}
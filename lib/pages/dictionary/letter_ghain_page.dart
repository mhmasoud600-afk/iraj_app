...
class LetterGhainPage extends StatefulWidget {
  const LetterGhainPage({Key? key}) : super(key: key);

  @override
  State<LetterGhainPage> createState() => _LetterGhainPageState();
}

class _LetterGhainPageState extends State<LetterGhainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف غ"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "غال", "en": "ghal", "desc": "سوراخ (غال مورچه)"},
    {"fa": "غدیلو", "en": "ghadeiloo", "desc": "چاله‌های کوچک در بیابان که هنگام بارندگی آب در آنها جمع شود (غدیر)"},
    {"fa": "غاز قُلَنگی", "en": "ghazgholangei", "desc": "ناهموار – جسم ناهموار، شخص بسیار لاغر (... این چوب خیلی غاز قلنگیه)"},
    {"fa": "غیره", "en": "", "desc": "غریبه"},
    {"fa": "غَیرَتو", "en": "", "desc": "حشره‌ای در بیابان که با چوب‌های ریز و آب دهان خانه می‌سازد؛ نماد پشتکار"},
    {"fa": "کاربافو", "en": "", "desc": "عنکبوت"},
  ];
}
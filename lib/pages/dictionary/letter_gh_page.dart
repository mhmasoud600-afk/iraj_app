...
class LetterGhPage extends StatefulWidget {
  const LetterGhPage({Key? key}) : super(key: key);

  @override
  State<LetterGhPage> createState() => _LetterGhPageState();
}

class _LetterGhPageState extends State<LetterGhPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ق"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "قیچ", "en": "gheich", "desc": "درختچه‌ای در بیابان‌های ایراج"},
    {"fa": "قد تو گور گذاشته", "en": "", "desc": "عبارتی برای پرخاش به بچه‌ها (... این بچه‌های قد تو گور گذاشته هر روز تو گله ور می‌دوَن)"},
    {"fa": "قاسمعلی یو", "en": "", "desc": "کفشدوزک؛ همراه شعر کودکانه هنگام پرواز کفشدوزک"},
    {"fa": "قاصد کورو", "en": "", "desc": "فردی که به‌طور سرّی نظر خانواده عروس را برای خواستگاری می‌پرسد"},
    {"fa": "قُلوُت", "en": "gholoot", "desc": "جمع شدن حیوانات در کنار هم (... همه گوسفندا یه جا قُلوُت شده بودن)"},
    {"fa": "قَنطِره", "en": "ghantera", "desc": "نوعی گیاه بلند سوزنی شکل همیشه سبز کنار جوی‌ها"},
    {"fa": "قَوَه سینی", "en": "ghava", "desc": "سینی"},
    {"fa": "قَلا قُلو", "en": "ghalagholoo", "desc": "همهمه (... اینقد قلاقلو نکنید)"},
    {"fa": "قُرقُچّو", "en": "ghorghochchoo", "desc": "غضروف"},
    {"fa": "قُپّه", "en": "ghoppa", "desc": "گل آفتابگردان"},
    {"fa": "قایمو", "en": "ghaeimoo", "desc": "بازی قایم‌موشک"},
    {"fa": "قرار بگیر", "en": "", "desc": "بنشین و اذیت نکن (... یه جا قرار بگیر)"},
    {"fa": "قُلُپ", "en": "gholop", "desc": "لپ"},
    {"fa": "قَلیف", "en": "ghaleif", "desc": "قابلمه"},
    {"fa": "قلیف زیر کردن", "en": "", "desc": "اصطلاحی در شخم زدن زمین برای شانه خالی کردن از کار"},
    {"fa": "قَیقاج", "en": "ghaeighaj", "desc": "کج"},
    {"fa": "قَلب", "en": "", "desc": "فضول (... عجب بچه قلبیه)"},
    {"fa": "قُرچ قُرچ", "en": "", "desc": "صدای گلو هنگام قورت دادن مایعات"},
    {"fa": "قاق ور زده", "en": "ghagh var zada", "desc": "صورت لاغر و نحیف"},
    {"fa": "قرقره افتادن", "en": "", "desc": "اسهال شدن"},
    {"fa": "قاش", "en": "ghash", "desc": "آب‌بردگی در دامنه کوه‌ها که طی سال‌ها عمیق شده باشد"},
    {"fa": "قَینقَینگو", "en": "", "desc": "اسباب‌بازی با نیمه پوست گردو، چرم و موی دم گاو که صدای زیادی دارد"},
    {"fa": "قُو", "en": "ghov", "desc": "قسمتی از شاخه درخت (پَده یا بنه) بسیار مسن که پوک شده باشد"},
  ];
}
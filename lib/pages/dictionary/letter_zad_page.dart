...
class LetterZadPage extends StatefulWidget {
  const LetterZadPage({Key? key}) : super(key: key);

  @override
  State<LetterZadPage> createState() => _LetterZadPageState();
}

class _LetterZadPageState extends State<LetterZadPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ض"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "ضِفنالی", "en": "", "desc": "ضعیف نالی؛ کنایه از فرد ضعیف و ناتوان"},
    {"fa": "ضربه", "en": "zarba", "desc": "ضربت، کوبش؛ برخورد ناگهانی"},
    {"fa": "ضامن", "en": "zamen", "desc": "متکفل، مسئول، کسی که تعهد می‌دهد"},
    {"fa": "ضیافت", "en": "ziafat", "desc": "پذیرایی، مهمانی دادن به دیگران"},
    {"fa": "ضد", "en": "zed", "desc": "مخالف، مقابل؛ چیزی که در تضاد با چیز دیگری باشد"},
    {"fa": "ضرر", "en": "zarar", "desc": "زیان، خسارت، آسیب مالی یا جانی"},
    {"fa": "ضلع", "en": "zel", "desc": "هر یک از اضلاع شکل هندسی؛ کنایه از سمت و سو"},
    {"fa": "ضرس", "en": "zers", "desc": "سختی و محکمی؛ کلمه‌ای در بیان استواری"},
  ];
}
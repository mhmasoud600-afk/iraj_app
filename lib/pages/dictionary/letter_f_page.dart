...
class LetterFPage extends StatefulWidget {
  const LetterFPage({Key? key}) : super(key: key);

  @override
  State<LetterFPage> createState() => _LetterFPageState();
}

class _LetterFPageState extends State<LetterFPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ف"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "فِلّه", "en": "fella", "desc": "آغوز، ماک"},
    {"fa": "فاش", "en": "fash", "desc": "فحش، ناسزا"},
    {"fa": "فُرت", "en": "fort", "desc": "سر کشیدن (... آبا فُرتش کن) = جرعه (یه فرت آب)"},
    {"fa": "فَند", "en": "fand", "desc": "فن، زیرکی (... فلانی خیلی فند داره)"},
    {"fa": "فَلَقو", "en": "falaghoo", "desc": "از ابزار نخ‌ریسی"},
    {"fa": "فرسق", "en": "farsagh", "desc": "فرسخ"},
    {"fa": "قول کردن", "en": "", "desc": "باور کردن (... من حرف‌های تو را قول نمی‌کنم)"},
    {"fa": "فنجون دوونو", "en": "fenjoon davoonoo", "desc": "اتاقکی در دشت ایراج برای سنجش میزان آب مصرفی زراعی در قدیم"},
    {"fa": "فرومونده", "en": "", "desc": "درمانده"},
  ];
}
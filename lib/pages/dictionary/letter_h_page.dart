...
class LetterHPage extends StatefulWidget {
  const LetterHPage({Key? key}) : super(key: key);

  @override
  State<LetterHPage> createState() => _LetterHPageState();
}

class _LetterHPageState extends State<LetterHPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ح"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "حَلُوَت", "en": "halovat", "desc": "مجال (... بشین بچه، حلوت بده)"},
    {"fa": "حِلفَت", "en": "helfat", "desc": "کار بد پنهانی (... باز چه حلفتی کردی؟)"},
    {"fa": "حُوضو", "en": "hovzoo", "desc": "اتاقکی نزدیک جوی آب؛ در قدیم آب را گرم می‌کردند و حمام می‌کردند"},
    {"fa": "حَکّو", "en": "hokkoo", "desc": "سکسکه"},
    {"fa": "حَکَم", "en": "", "desc": "تکیه‌گاه"},
    {"fa": "حالی", "en": "", "desc": "مشخص (... اصلاً حالی نمی‌شه این دو تا برادرن)"},
    {"fa": "حالیته", "en": "", "desc": "می‌فهمی؟"},
    {"fa": "حَظ کنی", "en": "", "desc": "کیف کنی (... همچون بزنمت که حظ کنی)"},
    {"fa": "حَدَس کردن", "en": "", "desc": "دست زدن از روی شادی (در عروسی)"},
  ];
}
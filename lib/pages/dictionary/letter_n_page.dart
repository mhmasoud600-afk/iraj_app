...
class LetterNPage extends StatefulWidget {
  const LetterNPage({Key? key}) : super(key: key);

  @override
  State<LetterNPage> createState() => _LetterNPageState();
}

class _LetterNPageState extends State<LetterNPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ن"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "نَهالی - نهالین", "en": "nahalein", "desc": "توشک"},
    {"fa": "ناشاغول", "en": "", "desc": "بد ذات"},
    {"fa": "ناخبرونه", "en": "na khabaroona", "desc": "بی‌خبر، ناگهان"},
    {"fa": "نوتُر – نوچَنگ", "en": "novtor", "desc": "قسمتی از جوی که آب از ارتفاع به پایین بریزد؛ ناودان"},
    {"fa": "ننگی", "en": "", "desc": "فضولی"},
    {"fa": "نیشک", "en": "neishk", "desc": "منقار (... خروس نیشکم زد)"},
    {"fa": "نَگَدو", "en": "nagadoo", "desc": "میوه نارس – توت نارس"},
    {"fa": "نیم چَنگ", "en": "neim chang", "desc": "نیم باز (در نیم باز)"},
    {"fa": "نُگو", "en": "nogoo", "desc": "ترد (... سبزی نُگو بچین)"},
    {"fa": "نَزلَه", "en": "nazla", "desc": "سرماخوردگی"},
    {"fa": "نُوَه", "en": "nova", "desc": "قسمت فرورفتگی پشت‌بام خانه‌های ضربی"},
    {"fa": "نکرده کار", "en": "", "desc": "شخصی که تن به کاری نمی‌دهد (... نکرده کار نبرش به کار)"},
    {"fa": "نِشون", "en": "", "desc": "محموله‌ای که از جایی برای کسی بفرستند"},
    {"fa": "نهیب نوا", "en": "", "desc": "پرخاش"},
    {"fa": "نون سیرو", "en": "seiroo", "desc": "نانی با سبزی دشتی سیرو"},
    {"fa": "نون زردو", "en": "zardoo", "desc": "نان چرب و زرد؛ بیشتر در قدیم در قبرستان خیرات می‌کردند"},
    {"fa": "نون کلاغ", "en": "", "desc": "قارچ"},
    {"fa": "نَهَنگ", "en": "nahang", "desc": "روش تکثیر درختان (خوابانیدن)"},
    {"fa": "نِزم", "en": "nezm", "desc": "باران ریز و مداوم چندین‌ساعته (... بارون نزم برا بیابون خوبه)"},
    {"fa": "نُفه", "en": "nofa", "desc": "جای کش شلوار"},
    {"fa": "نرم و نال", "en": "", "desc": "له"},
    {"fa": "نَسِرم", "en": "naserm", "desc": "محلی کم‌آفتاب (متضاد آفتابگیر) (... بیابونای نَسرمی هنوز هَنگش نوگوَه)"},
    {"fa": "ناچاری", "en": "", "desc": "خیلی کم، بگی نگی (... بارون اونقد نبود، ناچاری زمین تر شد)"},
    {"fa": "نیق", "en": "", "desc": "نیشخند"},
    {"fa": "نُتکه", "en": "", "desc": "جوانه"},
    {"fa": "ننه", "en": "", "desc": "مادربزرگ"},
    {"fa": "نه نه په", "en": "", "desc": "نوعی تعجب از رفتار"},
  ];
}
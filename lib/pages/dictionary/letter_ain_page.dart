...
class LetterAinPage extends StatefulWidget {
  const LetterAinPage({Key? key}) : super(key: key);

  @override
  State<LetterAinPage> createState() => _LetterAinPageState();
}

class _LetterAinPageState extends State<LetterAinPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ع"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "عروسو", "en": "aroosoo", "desc": "گوسفندی که صورت آن سفید باشد"},
    {"fa": "عِلک", "en": "elk", "desc": "صمغ درخت بنه"},
    {"fa": "علف گنده بو", "en": "", "desc": "نوعی علف بدبو که حتی گوسفندان هم به طرف آن نمی‌روند"},
    {"fa": "عَدل ظهر", "en": "adl", "desc": "سر ظهر"},
    {"fa": "عِبر", "en": "ebr", "desc": "زشت"},
    {"fa": "عبیر", "en": "", "desc": "کهیر"},
    {"fa": "عَلایده", "en": "alaeida", "desc": "بخصوص – عمداً (... علایده بهت نگفتم)"},
    {"fa": "عَمَله زمین کَن", "en": "", "desc": "کارگری که زمین را شخم می‌زند"},
    {"fa": "عمله پسیمی", "en": "", "desc": "کارگری که بعد از ظهر کار کند"},
    {"fa": "عَلد", "en": "", "desc": "عدل، صاف"},
    {"fa": "عکسه", "en": "", "desc": "عطسه"},
  ];
}
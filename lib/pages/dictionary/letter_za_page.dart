...
class LetterZaPage extends StatefulWidget {
  const LetterZaPage({Key? key}) : super(key: key);

  @override
  State<LetterZaPage> createState() => _LetterZaPageState();
}

class _LetterZaPageState extends State<LetterZaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ظ"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "ظاهر", "en": "zaher", "desc": "آنچه پیداست، مقابل باطن"},
    {"fa": "ظریف", "en": "zarif", "desc": "باریک و نازک، خوش‌اندام، با طبع لطیف"},
    {"fa": "ظلم", "en": "zolm", "desc": "ستم، بیداد، ناروا داشتن"},
    {"fa": "ظالم", "en": "zalem", "desc": "ستمکار، ستمگر"},
    {"fa": "ظهور", "en": "zohoor", "desc": "پیدا شدن، آشکار گردیدن"},
    {"fa": "ظرف", "en": "zerf", "desc": "آنچه در آن چیزی ریزند، مانند کاسه و بشقاب"},
    {"fa": "ظفر", "en": "zafar", "desc": "پیروزی، کامروایی"},
  ];
}
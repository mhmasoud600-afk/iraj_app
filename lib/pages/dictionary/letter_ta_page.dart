...
class LetterTaPage extends StatefulWidget {
  const LetterTaPage({Key? key}) : super(key: key);

  @override
  State<LetterTaPage> createState() => _LetterTaPageState();
}

class _LetterTaPageState extends State<LetterTaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("واژه‌های حرف ط"),
  ...
  final List<Map<String, String>> rawData = const [
    {"fa": "طناف", "en": "", "desc": "طناب"},
    {"fa": "طاس", "en": "tas", "desc": "کچل؛ کسی که موهای سرش ریخته باشد"},
    {"fa": "طوق", "en": "toghe", "desc": "گردنبند یا زنجیر دور گردن؛ کنایه از تحمل سختی"},
    {"fa": "طایفه", "en": "taife", "desc": "خانواده، قبیله، گروهی از خویشاوندان"},
    {"fa": "طبیب", "en": "tabib", "desc": "پزشک، دکتر؛ کسی که به درمان بیماری‌ها می‌پردازد"},
    {"fa": "طرز", "en": "tarz", "desc": "روش، شیوه، طریقه؛ نحوه انجام کار"},
    {"fa": "طرفه", "en": "tarfe", "desc": "نادر، کمیاب؛ چیز جالب و دیدنی"},
    {"fa": "طعم", "en": "tam", "desc": "مزه، طعم؛ کیفیت چشایی یک خوراکی"},
    {"fa": "طلب", "en": "talab", "desc": "خواستن، درخواست کردن؛ طلبکار بودن"},
    {"fa": "طلا", "en": "tala", "desc": "زر؛ فلز گران‌بهای زرد رنگ"},
    {"fa": "طوطی", "en": "toti", "desc": "نوعی پرنده زیبا و خوش‌صدا که می‌تواند حرف بزند"},
    {"fa": "طبیعت", "en": "tabiat", "desc": "سرشت، ذات؛ فضای پیرامون و محیط زیست"},
  ];
}